...
namespace WebApp_HangFire
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RouteDeliveryContext>(options =>
                    options.UseSqlServer(
                            Configuration.GetConnectionString("RouteDeliveryConnection")));
            ...
            services.AddScoped<IOptimizationEngineServices, OptimizationEngineServices>();
